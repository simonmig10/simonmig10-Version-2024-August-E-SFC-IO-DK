...
Thanks for taking a look at the model simulation code, if anything is unclear please feel free to reach out: sft@business.aau.dk.
...
library(readxl)
Model_data_1995 <- read_excel("Model data/Model_data_1995.xlsx") #Import sectoral national acc. data
Model_data_1996 <- read_excel("Model data/Model_data_1996.xlsx") #Import sectoral national acc. data
Trade_variables <- read_excel("Model data/Trade variables.xlsx") #Import trade variables
Model_data_collected_IO <- read_excel("Model data/Model_data_collected_IO_117.xlsx") # Import IO data
Emission_coeff_data <- read_excel("Model data/Emission_coeff_data.xlsx") # Import emission coeff data
Model_data_RER_1995 <- read_excel("Model data/Model_data_RER_1995.xlsx") # Import price and real exchange rate data
Model_data_RER_1996 <- read_excel("Model data/Model_data_RER_1996.xlsx") # Import price and real exchange rate data
Model_baci_data <- read_excel("Model data/Model_baci_data.xlsx") # Import market share data
Model_data_cons <- read_excel("Model data/Model_data_cons.xlsx") # Import consumption share data
Model_data_industry_sector_shares <- read_excel("Model data/Model_data_industry_sector_shares.xlsx") # Import shares connecting indsutry and sector data
...
S_modelData$pval=S_modelData$pval_io
...
S_modelData$valk_io=S_modelData$val/S_modelData$pval
...
S_modelData$yk_io= S_modelData$pconk_io + S_modelData$ik_io + S_modelData$inventk_io + S_modelData$valk_io + S_modelData$xk_io + S_modelData$gk_io - S_modelData$imk_io
...
S_modelData$valk=S_modelData$val/S_modelData$pval
...
S_modelData$yk= S_modelData$pconk + S_modelData$ik + S_modelData$inventk + S_modelData$valk + S_modelData$xk + S_modelData$gk - S_modelData$imk
