...
Trade_variables <- read_excel("Trade variables.xlsx")
...
S_modelData=c(Model_data_1995, Model_data_1996,Model_data_collected_IO,Trade_variables,Emission_coeff_data,Model_data_RER_1995,Model_data_RER_1996,Model_baci_data,Model_data_leak,Model_data_cons,Model_data_industry_sector_shares)
...
######### Shock 2 Implementing carbon tax.
...
```{r}
S_modelData$c_oth_envT=TIMESERIES(rep(0,25), START = c(1995,1), FREQ = 1)
S_modelData$c_110_envT=TIMESERIES(rep(0,25), START = c(1995,1), FREQ = 1)
S_modelData$c_120_envT=TIMESERIES(rep(0,25), START = c(1995,1), FREQ = 1)
S_modelData$c_130_envT=TIMESERIES(rep(0,25), START = c(1995,1), FREQ = 1)
S_modelData$c_140_envT=TIMESERIES(rep(0,25), START = c(1995,1), FREQ = 1)
S_modelData$c_160_envT=TIMESERIES(rep(0,25), START = c(1995,1), FREQ = 1)
S_modelData$c_180_envT=TIMESERIES(rep(0,25), START = c(1995,1), FREQ = 1)
...
Exo_model$simulation$nxk


Exo_model$simulation$s_ck_oth - S_modelData$s_ck_oth
Exo_model$simulation$s_ck_110 - S_modelData$s_ck_110
Exo_model$simulation$s_ck_120 - S_modelData$s_ck_120
Exo_model$simulation$s_ck_130 - S_modelData$s_ck_130
Exo_model$simulation$s_ck_140 - S_modelData$s_ck_140
Exo_model$simulation$s_ck_160 - S_modelData$s_ck_160
Exo_model$simulation$s_ck_180 - S_modelData$s_ck_180

Exo_model$simulation$s_ck_oth + Exo_model$simulation$s_ck_110 + Exo_model$simulation$s_ck_120 + Exo_model$simulation$s_ck_130 + Exo_model$simulation$s_ck_140 + Exo_model$simulation$s_ck_160 + Exo_model$simulation$s_ck_180



Exo_model$simulation$yd_hk_tax - S_modelData$yd_hk_tax
Exo_model$simulation$fnw_hk_tax - S_modelData$fnw_hk_tax

Exo_model$simulation$pout_1 - S_modelData$pout_1
Exo_model$simulation$pout_2 - S_modelData$pout_2
Exo_model$simulation$pout_3 - S_modelData$pout_3
Exo_model$simulation$pout_4 - S_modelData$pout_4
Exo_model$simulation$pout_5 - S_modelData$pout_5
Exo_model$simulation$pout_6 - S_modelData$pout_6
Exo_model$simulation$pout_7 - S_modelData$pout_7
Exo_model$simulation$pout_8 - S_modelData$pout_8


Exo_model$simulation$ppcon_tax - S_modelData$ppcon_tax
Exo_model$simulation$ppcon_ntax - S_modelData$ppcon_ntax

Exo_model$simulation$phi_c_oth - S_modelData$phi_c_oth
Exo_model$simulation$phi_c_110 - S_modelData$phi_c_110
Exo_model$simulation$phi_c_120 - S_modelData$phi_c_120
Exo_model$simulation$phi_c_130 - S_modelData$phi_c_130
Exo_model$simulation$phi_c_140 - S_modelData$phi_c_140
Exo_model$simulation$phi_c_160 - S_modelData$phi_c_160
Exo_model$simulation$phi_c_180 - S_modelData$phi_c_180




Exo_model$simulation$ppcon_ntax - Exo_model$simulation$ppcon # Very little difference, so maybe I should just ignore the taxes????


Exo_model$simulation$Xk_dom_2 - S_modelData$Xk_dom_2
Exo_model$simulation$Xk_dom_3 - S_modelData$Xk_dom_3
Exo_model$simulation$Xk_dom_4 - S_modelData$Xk_dom_4


Exo_model$simulation$b2_tot - S_modelData$b2_tot

Exo_model$simulation$b2_nfc_r - S_modelData$b2_nfc_r
Exo_model$simulation$b2_h_r - S_modelData$b2_h_r
Exo_model$simulation$b2_fc_r - S_modelData$b2_fc_r
Exo_model$simulation$b2_g_r - S_modelData$b2_g_r


Exo_model$simulation$i - S_modelData$i

Exo_model$simulation$i_nfc - S_modelData$i_nfc
Exo_model$simulation$i_fc - S_modelData$i_fc
Exo_model$simulation$i_g - S_modelData$i_g
Exo_model$simulation$i_h - S_modelData$i_h


Exo_model$simulation$ck_dom_5 - S_modelData$ck_dom_5
Exo_model$simulation$zk_dom_52 - S_modelData$zk_dom_52
Exo_model$simulation$zk_dom_53 - S_modelData$zk_dom_53
Exo_model$simulation$zk_dom_54 - S_modelData$zk_dom_54
Exo_model$simulation$zk_dom_55 - S_modelData$zk_dom_55
Exo_model$simulation$zk_dom_56 - S_modelData$zk_dom_56
Exo_model$simulation$zk_dom_57 - S_modelData$zk_dom_57
Exo_model$simulation$zk_dom_58 - S_modelData$zk_dom_58
Exo_model$simulation$zk_dom_59 - S_modelData$zk_dom_59

Exo_model$simulation$z_im_d_1 - S_modelData$z_im_d_1
Exo_model$simulation$z_im_d_2 - S_modelData$z_im_d_2
Exo_model$simulation$z_im_d_3 - S_modelData$z_im_d_3
Exo_model$simulation$z_im_d_4 - S_modelData$z_im_d_4
Exo_model$simulation$z_im_d_5 - S_modelData$z_im_d_5
Exo_model$simulation$z_im_d_6 - S_modelData$z_im_d_6
Exo_model$simulation$z_im_d_7 - S_modelData$z_im_d_7
Exo_model$simulation$z_im_d_8 - S_modelData$z_im_d_8
Exo_model$simulation$z_im_d_9 - S_modelData$z_im_d_9

Exo_model$simulation$c_im_d_tot - S_modelData$c_im_d_tot



Exo_model$simulation$Xk_dom_6 - S_modelData$Xk_dom_6
Exo_model$simulation$Xk_dom_7 - S_modelData$Xk_dom_7
Exo_model$simulation$Xk_dom_8 - S_modelData$Xk_dom_8
Exo_model$simulation$Xk_dom_9 - S_modelData$Xk_dom_9



Exo_model$simulation$y - (Exo_model$simulation$b2_tot + Exo_model$simulation$w_nfc + Exo_model$simulation$opt_tot + Exo_model$simulation$n_prod_tax_tot)



Exo_model$simulation$exk_1 - S_modelData$exk_1
Exo_model$simulation$market_share_1 - S_modelData$market_share_1
Exo_model$simulation$rer_1 - S_modelData$rer_1



Exo_model$simulation$pim_oth - S_modelData$pim_oth
Exo_model$simulation$ppcon_oth - S_modelData$ppcon_oth


Exo_model$simulation$c_oth_im_1 - S_modelData$c_oth_im_1




Exo_model$simulation$rer_oth - S_modelData$rer_oth
Exo_model$simulation$phi_c_oth - S_modelData$phi_c_oth



Exo_model$simulation$tot_env_tax_exc_rent_1 - S_modelData$tot_env_tax_exc_rent_1
Exo_model$simulation$tot_env_tax_exc_rent_2 - S_modelData$tot_env_tax_exc_rent_2
Exo_model$simulation$tot_env_tax_exc_rent_3 - S_modelData$tot_env_tax_exc_rent_3
Exo_model$simulation$tot_env_tax_exc_rent_4 - S_modelData$tot_env_tax_exc_rent_4
Exo_model$simulation$tot_env_tax_exc_rent_5 - S_modelData$tot_env_tax_exc_rent_5
Exo_model$simulation$tot_env_tax_exc_rent_6 - S_modelData$tot_env_tax_exc_rent_6
Exo_model$simulation$tot_env_tax_exc_rent_7 - S_modelData$tot_env_tax_exc_rent_7
Exo_model$simulation$tot_env_tax_exc_rent_8 - S_modelData$tot_env_tax_exc_rent_8
Exo_model$simulation$tot_env_tax_exc_rent_9 - S_modelData$tot_env_tax_exc_rent_9

Exo_model$simulation$w_1 - S_modelData$w_1
Exo_model$simulation$w_2 - S_modelData$w_2

Exo_model$simulation$avg_w - S_modelData$avg_w_test


Exo_model$simulation$exk_dom_1 - S_modelData$exk_dom_1
Exo_model$simulation$exk_dom_3 - S_modelData$exk_dom_3
Exo_model$simulation$exk_dom_4 - S_modelData$exk_dom_4
Exo_model$simulation$exk_dom_5 - S_modelData$exk_dom_5
Exo_model$simulation$exk_dom_6 - S_modelData$exk_dom_6
Exo_model$simulation$exk_dom_7 - S_modelData$exk_dom_7


Exo_model$simulation$CH4_tot - S_modelData$CH4_tot # I think the divergeses are very small, it seems like the code is correct.

Exo_model$simulation$CH4_tot_1 - S_modelData$CH4_tot_1
Exo_model$simulation$CH4_tot_2 - S_modelData$CH4_tot_2
Exo_model$simulation$CH4_tot_3 - S_modelData$CH4_tot_3
Exo_model$simulation$CH4_tot_4 - S_modelData$CH4_tot_4
Exo_model$simulation$CH4_tot_5 - S_modelData$CH4_tot_5
Exo_model$simulation$CH4_tot_5_energy - S_modelData$CH4_tot_5_energy
S_modelData$NGasCons_5 - Exo_model$simulation$NGasCons_5 ### Most of the difference comes from this
Exo_model$simulation$CH4_tot_6 - S_modelData$CH4_tot_6
Exo_model$simulation$CH4_tot_7 - S_modelData$CH4_tot_7



Exo_model$simulation$Co2_tot - S_modelData$Co2_tot

Exo_model$simulation$Co2_tot_1 - S_modelData$Co2_tot_1
Exo_model$simulation$Co2_tot_2 - S_modelData$Co2_tot_2
Exo_model$simulation$Co2_tot_3 - S_modelData$Co2_tot_3
Exo_model$simulation$Co2_tot_4 - S_modelData$Co2_tot_4
Exo_model$simulation$Co2_tot_5 - S_modelData$Co2_tot_5 ##### Again most of the difference comes from 5th industry
Exo_model$simulation$Co2_tot_6 - S_modelData$Co2_tot_6
Exo_model$simulation$Co2_tot_7 - S_modelData$Co2_tot_7

Exo_model$simulation$Co2E_1 - S_modelData$Co2E_1


Exo_model$simulation$Co2E_u_1 - Exo_model$simulation$Co2_tot_1

Exo_model$simulation$N2O_tot - S_modelData$N2O_tot

Exo_model$simulation$HFC_tot - S_modelData$HFC_tot

Exo_model$simulation$PFC_tot - S_modelData$PFC_tot

Exo_model$simulation$SF6_tot - S_modelData$SF6_tot
...
plot(Exo_model$simulation$exk_im_1, col= "red", ylab= "B. DKR" , main= "Agriculture", lwd=3, xlab="" , cex.main=2); lines(S_modelData$exk_im_1, col = "blue", lwd=3, xlab="",cex = 1.5); 
legend("topleft",legend=c("Model (baseline)", "Data"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue"), cex=2); grid()

plot(Exo_model$simulation$exk_2, col= "red", ylab= "B. DKR" , main= "Forresty", lwd=3, xlab="" , cex.main=2); lines(S_modelData$exk_2, col = "blue", lwd=3, xlab="",cex = 1.5); 
legend("topleft",legend=c("Model (baseline)", "Data"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue"), cex=2); grid()

plot(Exo_model$simulation$exk_3, col= "red", ylab= "B. DKR" , main= "Fishery", lwd=3, xlab="", ylim= c(3.5,6) , cex.main=2); lines(S_modelData$exk_3, col = "blue", lwd=3, xlab="",cex = 1.5); 
legend("topleft",legend=c("Model (baseline)", "Data"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue"), cex=2); grid()

plot(Exo_model$simulation$exk_4, col= "red", ylab= "B. DKR" , main= "Mining", lwd=3, xlab="",ylim= c(30,86) , cex.main=2); lines(S_modelData$exk_4, col = "blue", lwd=3, xlab="",cex = 1.5); 
legend("topleft",legend=c("Model (baseline)", "Data"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue"), cex=2); grid()

plot(Exo_model$simulation$exk_5, col= "red", ylab= "B. DKR" , main= "Manufacturing food", lwd=3, xlab="" , cex.main=2); lines(S_modelData$exk_5, col = "blue", lwd=3, xlab="",cex = 1.5); 
legend("topleft",legend=c("Model (baseline)", "Data"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue"), cex=2); grid()

plot(Exo_model$simulation$exk_6, col= "red", ylab= "B. DKR" , main= "Energy supply and refinaries", lwd=3, xlab="" ,ylim= c(80,100), cex.main=2); lines(S_modelData$exk_6, col = "blue", lwd=3, xlab=""); 
legend("topleft",legend=c("Model (baseline)", "Data"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue"), cex=2); grid()

plot(Exo_model$simulation$exk_7, col= "red", ylab= "B. DKR" , main= "Energy intensive industries", lwd=3, xlab="" , cex.main=2); lines(S_modelData$exk_7, col = "blue", lwd=3, xlab="",cex = 1.5); 
legend("topleft",legend=c("Model (baseline)", "Data"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue"), cex=2); grid()

plot(Exo_model$simulation$exk_8, col= "red", ylab= "B. DKR" , main= "Financial corporations", lwd=3, xlab="" , cex.main=2); lines(S_modelData$exk_8, col = "blue", lwd=3, xlab="",cex = 1.5); 
legend("topleft",legend=c("Model (baseline)", "Data"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue"), cex=2); grid()

plot(Exo_model$simulation$exk_9, col= "red", ylab= "B. DKR" , main= "Other industries", lwd=3, xlab="" , cex.main=2); lines(S_modelData$exk_9, col = "blue", lwd=3, xlab="",cex = 1.5); 
legend("topleft",legend=c("Model (baseline)", "Data"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue"), cex=2); grid()
...
```{r}
env_ntax_tot_bs = Exo_model$simulation$env_ntax_1 + Exo_model$simulation$env_ntax_2 + Exo_model$simulation$env_ntax_3 + Exo_model$simulation$env_ntax_4 + Exo_model$simulation$env_ntax_5 + Exo_model$simulation$env_ntax_6 + Exo_model$simulation$env_ntax_7

env_ntax_tot = S_modelData$env_ntax_1 + S_modelData$env_ntax_2 + S_modelData$env_ntax_3 + S_modelData$env_ntax_4 + S_modelData$env_ntax_5 + S_modelData$env_ntax_6 + S_modelData$env_ntax_7
```
...
plot(Exo_model$simulation$rer_9, col= "red", ylab= "1000 Tons Co2" , main= "Total Co2-E emission" , lwd=3, xlab=""); lines(S_modelData$rer_1, col = "blue", lwd=3, xlab=""); 
legend("topleft",legend=c("Model (baseline)", "Data"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue")); grid()

plot(Exo_model$simulation$rer_5, col= "red", ylab= "B. DKK" , main= "Co2-E emission Agriculture" , xlim= c(1998,2020) , lwd=3, xlab=""); lines(S_modelData$rer_5, col = "blue", lwd=3, xlab=""); 
legend("topleft",legend=c("Model (baseline)", "Data"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue")); grid()
...
test_1=Exo_model_S1$simulation$s_ck_oth - Exo_model$simulation$s_ck_oth
test_2=Exo_model_S1$simulation$s_ck_110 - Exo_model$simulation$s_ck_110
test_3=Exo_model_S1$simulation$s_ck_120 - Exo_model$simulation$s_ck_120
test_4=Exo_model_S1$simulation$s_ck_130 - Exo_model$simulation$s_ck_130
test_5=Exo_model_S1$simulation$s_ck_140 - Exo_model$simulation$s_ck_140
test_6=Exo_model_S1$simulation$s_ck_160 - Exo_model$simulation$s_ck_160
test_7=Exo_model_S1$simulation$s_ck_180 - Exo_model$simulation$s_ck_180

test_1 + test_2 + test_3 + test_4 +test_5 + test_6 + test_7



Exo_model_S1$simulation$s_ck_oth + Exo_model_S1$simulation$s_ck_110 + Exo_model_S1$simulation$s_ck_120 + Exo_model_S1$simulation$s_ck_130 + Exo_model_S1$simulation$s_ck_140 + Exo_model_S1$simulation$s_ck_160 + Exo_model_S1$simulation$s_ck_180


(Exo_model_S1$simulation$yk - Exo_model$simulation$yk)/(Exo_model_S1$simulation$gk - Exo_model$simulation$gk)
...
plot((Exo_model_S1$simulation$xk - Exo_model$simulation$xk)/Exo_model$simulation$xk*100, col= "red", ylab= "Percentage change from Baseline" , main= "Real Export",ylim=c(0,1), xlim= c(c(1998,2020)), lwd=3, xlab="", cex.main=1.8);grid()

plot((Exo_model_S1$simulation$imk - Exo_model$simulation$imk)/Exo_model$simulation$imk*100, col= "red", ylab= "Percentage change from Baseline" , main= "Real Import" , xlim= c(c(1998,2020)), lwd=3, xlab="", cex.main=1.8);grid()
...
Exo_model_S2$simulation$s_ck_oth - Exo_model$simulation$s_ck_oth 
Exo_model_S2$simulation$s_ck_110 - Exo_model$simulation$s_ck_110
Exo_model_S2$simulation$s_ck_120 - Exo_model$simulation$s_ck_120
Exo_model_S2$simulation$s_ck_130 - Exo_model$simulation$s_ck_130
Exo_model_S2$simulation$s_ck_140 - Exo_model$simulation$s_ck_140
Exo_model_S2$simulation$s_ck_160 - Exo_model$simulation$s_ck_160
Exo_model_S2$simulation$s_ck_180 - Exo_model$simulation$s_ck_180


Exo_model_S2$simulation$s_ck_oth + Exo_model_S2$simulation$s_ck_110 + Exo_model_S2$simulation$s_ck_120 + Exo_model_S2$simulation$s_ck_130 + Exo_model_S2$simulation$s_ck_140 + Exo_model_S2$simulation$s_ck_160 + Exo_model_S2$simulation$s_ck_180
...
plot((Exo_model_S2$simulation$opt_1 - Exo_model$simulation$opt_1), col= "red", ylab= "Level change from baseline" , main= "Other production taxes", lwd=3, ylim= c(-0,6));
lines((Exo_model_S2$simulation$opt_2 - Exo_model$simulation$opt_2), col = "blue", lwd=3, xlab=""); 
lines((Exo_model_S2$simulation$opt_3 - Exo_model$simulation$opt_3), col = "green", lwd=3, xlab="");
lines((Exo_model_S2$simulation$opt_4 - Exo_model$simulation$opt_4), col = "black", lwd=3, xlab="");
lines((Exo_model_S2$simulation$opt_5 - Exo_model$simulation$opt_5), col = "orange", lwd=3, xlab="");
lines((Exo_model_S2$simulation$opt_6 - Exo_model$simulation$opt_6), col = "yellow", lwd=3, xlab="");
lines((Exo_model_S2$simulation$opt_7 - Exo_model$simulation$opt_7), col = "pink", lwd=3, xlab="");
lines((Exo_model_S2$simulation$opt_8 - Exo_model$simulation$opt_8), col = "darkgreen", lwd=3, xlab="");
lines((Exo_model_S2$simulation$opt_9 - Exo_model$simulation$opt_9), col = "darkblue", lwd=3, xlab="");
...
plot((Exo_model_S2$simulation$pout_1 - Exo_model$simulation$pout_1)/Exo_model$simulation$pout_1*100, col= "red", ylab= "% change from baseline" , main= "Industry prices", lwd=3, ylim= c(-2,10));
lines((Exo_model_S2$simulation$pout_2 - Exo_model$simulation$pout_2)/Exo_model$simulation$pout_2*100, col = "blue", lwd=3, xlab=""); 
lines((Exo_model_S2$simulation$pout_3 - Exo_model$simulation$pout_3)/Exo_model$simulation$pout_3*100, col = "green", lwd=3, xlab="");
lines((Exo_model_S2$simulation$pout_4 - Exo_model$simulation$pout_4)/Exo_model$simulation$pout_4*100, col = "black", lwd=3, xlab="");
lines((Exo_model_S2$simulation$pout_5 - Exo_model$simulation$pout_5)/Exo_model$simulation$pout_5*100, col = "orange", lwd=3, xlab="");
lines((Exo_model_S2$simulation$pout_6 - Exo_model$simulation$pout_6)/Exo_model$simulation$pout_6*100, col = "yellow", lwd=3, xlab="");
lines((Exo_model_S2$simulation$pout_7 - Exo_model$simulation$pout_7)/Exo_model$simulation$pout_7*100, col = "pink", lwd=3, xlab="");
lines((Exo_model_S2$simulation$pout_8 - Exo_model$simulation$pout_8)/Exo_model$simulation$pout_8*100, col = "darkgreen", lwd=3, xlab="");
lines((Exo_model_S2$simulation$pout_9 - Exo_model$simulation$pout_9)/Exo_model$simulation$pout_9*100, col = "darkblue", lwd=3, xlab="");
legend("topleft",legend=c("Industry 1 (Agriculture)", "Industry 2 (Forresty)","Industry 3 (Fishery)","Industry 4 (Mining)","Industry 5 (Manu. food)","Industry 6 (Energy prod.)","Industry 7 (Energy inten.)","Industry 8 (Financial corp.)","Industry 9 (other industries)"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue","green", "black","orange", "yellow", "pink", "darkgreen", "darkblue")); grid()



plot((Exo_model_S2$simulation$ppcon_oth_tot - Exo_model$simulation$ppcon_oth_tot)*100, ylim=c(-0,3),col= "red", ylab= "Change in percentage points" , main= "Final consumption prices", lwd=3, xlab="", cex.main=1);
...
plot((Exo_model_S2$simulation$ck_oth_tot - Exo_model$simulation$ck_oth_tot)/Exo_model$simulation$ck_oth_tot*100, ylim=c(-2,2),col= "red", ylab= "% change from baseline" , main= "Real consumptions", lwd=3, xlab="", cex.main=1);
...
We need to calculate average import shares
...
plot((Exo_model_S2$simulation$exk_dom_1 - Exo_model$simulation$exk_dom_1)/Exo_model$simulation$exk_dom_1*100, ylim=c(-50,2),col= "red", ylab= "Percentage change" , main= "Change in Real Exports", lwd=3, xlab="", cex.main=1.5);
...
plot((Exo_model_S2$simulation$phi_c_oth - Exo_model$simulation$phi_c_oth)*100, col= "red", ylab= "Level change from baseline" , main= "Import shares of final consumption", lwd=3, ylim= c(-0,2), cex.main=1.5);
...
plot(zk_im_1_tot_S2/zk_1_tot_S2*100 - zk_im_1_tot_BS/zk_1_tot_BS*100, col= "red", ylab= "Percentage change from baseline" , main= "Import shares on inputs", lwd=3, ylim= c(-0.2,2), cex.main=1.5);
...
plot((Exo_model_S2$simulation$nxk - Exo_model$simulation$nxk), col= "red", ylab= "Change from baseline (B. DKR)" , main= "Real net-export" , xlim= c(1998,2020), lwd=3, xlab="", cex.main=1.5);grid()
...
Her finder de en reduktion på 750.000 tons co2e https://dreamgruppen.dk/media/9770/effekter_af_to_stod_til_landbruget.pdf

```{r, fig.height=6, fig.width=15}

par(mfrow=c(1,2))

plot((Exo_model_S2$simulation$Co2E_1 - Exo_model$simulation$Co2E_1)/Exo_model$simulation$Co2E_1*100, col= "red", ylab= "Percentage change from baseline" , main= "Total Co2-Equivelant emission", lwd=3, ylim= c(-25,1));
...
plot((Exo_model_S2$simulation$Co2E_tot - Exo_model$simulation$Co2E_tot)/Exo_model$simulation$Co2E_tot*100, col= "red", ylab= "Percentage change from baseline" , main= "Total Co2-Equivelant emission", lwd=3); 
...
plot((Exo_model_S2$simulation$fnw_nfck - Exo_model$simulation$fnw_nfck), col= "red", ylab= "Change from baseline (B. DKR)" , main= "Real financial net wealth: NFC" , xlim= c(1998,2020), lwd=3, xlab="", cex.main=1.5);grid()

plot((Exo_model_S2$simulation$fnw_hk - Exo_model$simulation$fnw_hk), col= "red", ylab= "Change from baseline (B. DKR)" , main= "Real financial net wealth: HH" , xlim= c(1998,2020), lwd=3, xlab="", cex.main=1.5);grid()

plot((Exo_model_S2$simulation$fnw_gk - Exo_model$simulation$fnw_gk), col= "red", ylab= "Change from baseline (B. DKR)" , main= "Real financial net wealth: GOV" , xlim= c(1998,2020), lwd=3, xlab="", cex.main=1.5);grid()

plot((Exo_model_S2$simulation$fnw_rowk - Exo_model$simulation$fnw_rowk), col= "red", ylab= "Change from baseline (B. DKR)" , main= "Real financial net wealth: ROW" , xlim= c(1998,2020), lwd=3, xlab="", cex.main=1.5);grid()
...
plot((Exo_model_S3$simulation$yk - Exo_model$simulation$yk)/Exo_model$simulation$yk*100, col= "red", ylab= "Percentage change from Baseline" , main= "Real GDP" , xlim= c(c(1998,2020)), lwd=3, xlab="", cex.main=1.8);grid()

plot((Exo_model_S3$simulation$pconk - Exo_model$simulation$pconk)/Exo_model$simulation$pconk*100, col= "red", ylab= "Percentage change from Baseline" , main= "Real Consumption" , xlim= c(c(1998,2020)), lwd=3, xlab="", cex.main=1.8);grid()

plot((Exo_model_S3$simulation$ik - Exo_model$simulation$ik)/Exo_model$simulation$ik*100, col= "red", ylab= "Percentage change from Baseline" , main= "Real Investment" , xlim= c(c(1998,2020)), lwd=3, xlab="", cex.main=1.8);grid()

plot((Exo_model_S3$simulation$xk - Exo_model$simulation$xk)/Exo_model$simulation$xk*100, col= "red", ylab= "Percentage change from Baseline" , main= "Real exports" , ylim=c(-1,0),xlim= c(c(1998,2020)), lwd=3, xlab="", cex.main=1.8);grid()

plot((Exo_model_S3$simulation$imk - Exo_model$simulation$imk)/Exo_model$simulation$imk*100, col= "red", ylab= "Percentage change from Baseline" , main= "Real imports" , xlim= c(c(1998,2020)), lwd=3, xlab="", cex.main=1.8);grid()

plot((Exo_model_S3$simulation$emp_tot - Exo_model$simulation$emp_tot)/Exo_model$simulation$emp_tot*100, col= "red", ylab= "Percentage change from Baseline" , main= "Employment" , xlim= c(c(1998,2020)), lwd=3, xlab="", cex.main=1.8);grid()
...
zk_dom_9_sales_S3 = Exo_model_S3$simulation$zk_dom_91 + Exo_model_S3$simulation$zk_dom_92 + Exo_model_S3$simulation$zk_dom_93 + Exo_model_S3$simulation$zk_dom_94 + Exo_model_S3$simulation$zk_dom_95 + Exo_model_S3$simulation$zk_dom_96 + Exo_model_S3$simulation$zk_dom_97 + Exo_model_S3$simulation$zk_dom_98 + Exo_model_S3$simulation$zk_dom_99 
```
...
# First plot
plot((Exo_model_S3$simulation$Xk_dom_1 - Exo_model$simulation$Xk_dom_1)/Exo_model$simulation$Xk_dom_1*100,
     col = "red", ylab = "% change from baseline", main = "Total sales", lwd = 3, ylim = c(-2, 2.5))
lines((Exo_model_S3$simulation$Xk_dom_2 - Exo_model$simulation$Xk_dom_2)/Exo_model$simulation$Xk_dom_2*100, col = "blue", lwd = 3)
lines((Exo_model_S3$simulation$Xk_dom_3 - Exo_model$simulation$Xk_dom_3)/Exo_model$simulation$Xk_dom_3*100, col = "green", lwd = 3)
lines((Exo_model_S3$simulation$Xk_dom_4 - Exo_model$simulation$Xk_dom_4)/Exo_model$simulation$Xk_dom_4*100, col = "black", lwd = 3)
lines((Exo_model_S3$simulation$Xk_dom_5 - Exo_model$simulation$Xk_dom_5)/Exo_model$simulation$Xk_dom_5*100, col = "orange", lwd = 3)
lines((Exo_model_S3$simulation$Xk_dom_6 - Exo_model$simulation$Xk_dom_6)/Exo_model$simulation$Xk_dom_6*100, col = "yellow", lwd = 3)
lines((Exo_model_S3$simulation$Xk_dom_7 - Exo_model$simulation$Xk_dom_7)/Exo_model$simulation$Xk_dom_7*100, col = "pink", lwd = 3)
lines((Exo_model_S3$simulation$Xk_dom_8 - Exo_model$simulation$Xk_dom_8)/Exo_model$simulation$Xk_dom_8*100, col = "darkgreen", lwd = 3)
lines((Exo_model_S3$simulation$Xk_dom_9 - Exo_model$simulation$Xk_dom_9)/Exo_model$simulation$Xk_dom_9*100, col = "darkblue", lwd = 3)
legend("topleft", legend = c("Industry 1 (Agriculture)", "Industry 2 (Forestry)", "Industry 3 (Fishery)",
                             "Industry 4 (Mining)", "Industry 5 (Manu. food)", "Industry 6 (Energy prod.)",
                             "Industry 7 (Energy inten.)", "Industry 8 (Financial corp.)", "Industry 9 (other industries)"),
       lty = 1, lwd = 2, bty = "n", col = c("red", "blue", "green", "black", "orange", "yellow", "pink", "darkgreen", "darkblue"))
...
# Second plot
plot((Exo_model_S3$simulation$ck_dom_1 - Exo_model$simulation$ck_dom_1)/Exo_model$simulation$ck_dom_1*100,
     col = "red", ylab = "% change from baseline", main = "Real final consumption", lwd = 3, ylim = c(-3, 0.5))
lines((Exo_model_S3$simulation$ck_dom_2 - Exo_model$simulation$ck_dom_2)/Exo_model$simulation$ck_dom_2*100, col = "blue", lwd = 3)
lines((Exo_model_S3$simulation$ck_dom_3 - Exo_model$simulation$ck_dom_3)/Exo_model$simulation$ck_dom_3*100, col = "green", lwd = 3)
lines((Exo_model_S3$simulation$ck_dom_4 - Exo_model$simulation$ck_dom_4)/Exo_model$simulation$ck_dom_4*100, col = "black", lwd = 3)
lines((Exo_model_S3$simulation$ck_dom_5 - Exo_model$simulation$ck_dom_5)/Exo_model$simulation$ck_dom_5*100, col = "orange", lwd = 3)
lines((Exo_model_S3$simulation$ck_dom_6 - Exo_model$simulation$ck_dom_6)/Exo_model$simulation$ck_dom_6*100, col = "yellow", lwd = 3)
lines((Exo_model_S3$simulation$ck_dom_7 - Exo_model$simulation$ck_dom_7)/Exo_model$simulation$ck_dom_7*100, col = "pink", lwd = 3)
lines((Exo_model_S3$simulation$ck_dom_8 - Exo_model$simulation$ck_dom_8)/Exo_model$simulation$ck_dom_8*100, col = "darkgreen", lwd = 3)
lines((Exo_model_S3$simulation$ck_dom_9 - Exo_model$simulation$ck_dom_9)/Exo_model$simulation$ck_dom_9*100, col = "darkblue", lwd = 3)
...
plot((Exo_model_S3$simulation$exk_dom_1 - Exo_model$simulation$exk_dom_1)/Exo_model$simulation$exk_dom_1*100,
     col = "red", ylab = "% change from baseline", main = "Real exports", lwd = 3, ylim = c(-1, 0.5))
lines((Exo_model_S3$simulation$exk_dom_2 - Exo_model$simulation$exk_dom_2)/Exo_model$simulation$exk_dom_2*100, col = "blue", lwd = 3)
lines((Exo_model_S3$simulation$exk_dom_3 - Exo_model$simulation$exk_dom_3)/Exo_model$simulation$exk_dom_3*100, col = "green", lwd = 3)
lines((Exo_model_S3$simulation$exk_dom_4 - Exo_model$simulation$exk_dom_4)/Exo_model$simulation$exk_dom_4*100, col = "black", lwd = 3)
lines((Exo_model_S3$simulation$exk_dom_5 - Exo_model$simulation$exk_dom_5)/Exo_model$simulation$exk_dom_5*100, col = "orange", lwd = 3)
lines((Exo_model_S3$simulation$exk_dom_6 - Exo_model$simulation$exk_dom_6)/Exo_model$simulation$exk_dom_6*100, col = "yellow", lwd = 3)
lines((Exo_model_S3$simulation$exk_dom_7 - Exo_model$simulation$exk_dom_7)/Exo_model$simulation$exk_dom_7*100, col = "pink", lwd = 3)
lines((Exo_model_S3$simulation$exk_dom_8 - Exo_model$simulation$exk_dom_8)/Exo_model$simulation$exk_dom_8*100, col = "darkgreen", lwd = 3)
lines((Exo_model_S3$simulation$exk_dom_9 - Exo_model$simulation$exk_dom_9)/Exo_model$simulation$exk_dom_9*100, col = "darkblue", lwd = 3)
legend("bottomleft", legend = c("Industry 1 (Agriculture)", "Industry 2 (Forestry)", "Industry 3 (Fishery)",
                                "Industry 4 (Mining)", "Industry 5 (Manu. food)", "Industry 6 (Energy prod.)",
                                "Industry 7 (Energy inten.)", "Industry 8 (Financial corp.)", "Industry 9 (other industries)"),
       lty = 1, lwd = 2, bty = "n", col = c("red", "blue", "green", "black", "orange", "yellow", "pink", "darkgreen", "darkblue"))
...
plot((zk_dom_1_sales_S3 - zk_dom_1_sales_BS)/zk_dom_1_sales_BS*100,
     col = "red", ylab = "% change from baseline", main = "Real intermediate consumption", lwd = 3, ylim = c(-1.3, 0.5))
lines((zk_dom_2_sales_S3 - zk_dom_2_sales_BS)/zk_dom_2_sales_BS*100, col = "blue", lwd = 3)
lines((zk_dom_3_sales_S3 - zk_dom_3_sales_BS)/zk_dom_3_sales_BS*100, col = "green", lwd = 3)
lines((zk_dom_4_sales_S3 - zk_dom_4_sales_BS)/zk_dom_4_sales_BS*100, col = "black", lwd = 3)
lines((zk_dom_5_sales_S3 - zk_dom_5_sales_BS)/zk_dom_5_sales_BS*100, col = "orange", lwd = 3)
lines((zk_dom_6_sales_S3 - zk_dom_6_sales_BS)/zk_dom_6_sales_BS*100, col = "yellow", lwd = 3)
lines((zk_dom_7_sales_S3 - zk_dom_7_sales_BS)/zk_dom_7_sales_BS*100, col = "pink", lwd = 3)
lines((zk_dom_8_sales_S3 - zk_dom_8_sales_BS)/zk_dom_8_sales_BS*100, col = "darkgreen", lwd = 3)
lines((zk_dom_9_sales_S3 - zk_dom_9_sales_BS)/zk_dom_9_sales_BS*100, col = "darkblue", lwd = 3)
legend("bottomleft", legend = c("Industry 1 (Agriculture)", "Industry 2 (Forestry)", "Industry 3 (Fishery)",
                                "Industry 4 (Mining)", "Industry 5 (Manu. food)", "Industry 6 (Energy prod.)",
                                "Industry 7 (Energy inten.)", "Industry 8 (Financial corp.)", "Industry 9 (other industries)"),
       lty = 1, lwd = 2, bty = "n", col = c("red", "blue", "green", "black", "orange", "yellow", "pink", "darkgreen", "darkblue"))
...
plot((Exo_model_S3$simulation$ck_dom_1 - Exo_model$simulation$ck_dom_1)/Exo_model$simulation$ck_dom_1*100, col= "red", ylab= "% change from baseline" , main= "Final consumption (domestic products)", lwd=3, ylim= c(-5,0));
lines((Exo_model_S3$simulation$ck_dom_2 - Exo_model$simulation$ck_dom_2)/Exo_model$simulation$ck_dom_2*100, col = "blue", lwd=3, xlab=""); 
lines((Exo_model_S3$simulation$ck_dom_3 - Exo_model$simulation$ck_dom_3)/Exo_model$simulation$ck_dom_3*100, col = "green", lwd=3, xlab="");
lines((Exo_model_S3$simulation$ck_dom_4 - Exo_model$simulation$ck_dom_4)/Exo_model$simulation$ck_dom_4*100, col = "black", lwd=3, xlab="");
lines((Exo_model_S3$simulation$ck_dom_5 - Exo_model$simulation$ck_dom_5)/Exo_model$simulation$ck_dom_5*100, col = "orange", lwd=3, xlab="");
lines((Exo_model_S3$simulation$ck_dom_6 - Exo_model$simulation$ck_dom_6)/Exo_model$simulation$ck_dom_6*100, col = "yellow", lwd=3, xlab="");
lines((Exo_model_S3$simulation$ck_dom_7 - Exo_model$simulation$ck_dom_7)/Exo_model$simulation$ck_dom_7*100, col = "pink", lwd=3, xlab="");
lines((Exo_model_S3$simulation$ck_dom_8 - Exo_model$simulation$ck_dom_8)/Exo_model$simulation$ck_dom_8*100, col = "darkgreen", lwd=3, xlab="");
lines((Exo_model_S3$simulation$ck_dom_9 - Exo_model$simulation$ck_dom_9)/Exo_model$simulation$ck_dom_9*100, col = "darkblue", lwd=3, xlab="");
legend("bottomleft",legend=c("Industry 1 (Agriculture)", "Industry 2 (Forresty)","Industry 3 (Fishery)","Industry 4 (Mining)","Industry 5 (Manu. food)","Industry 6 (Energy prod.)","Industry 7 (Energy inten.)","Industry 8 (Financial corp.)","Industry 9 (other industries)"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue","green", "black","orange", "yellow", "pink", "darkgreen", "darkblue")); grid()



plot((Exo_model_S3$simulation$ck_im_1 - Exo_model$simulation$ck_im_1)/Exo_model$simulation$ck_im_1*100, col= "red", ylab= "% change from baseline" , main= "Final consumption (imported products)", lwd=3, ylim= c(-5,0));
lines((Exo_model_S3$simulation$ck_im_2 - Exo_model$simulation$ck_im_2)/Exo_model$simulation$ck_im_2*100, col = "blue", lwd=3, xlab=""); 
lines((Exo_model_S3$simulation$ck_im_3 - Exo_model$simulation$ck_im_3)/Exo_model$simulation$ck_im_3*100, col = "green", lwd=3, xlab="");
lines((Exo_model_S3$simulation$ck_im_4 - Exo_model$simulation$ck_im_4)/Exo_model$simulation$ck_im_4*100, col = "black", lwd=3, xlab="");
lines((Exo_model_S3$simulation$ck_im_5 - Exo_model$simulation$ck_im_5)/Exo_model$simulation$ck_im_5*100, col = "orange", lwd=3, xlab="");
lines((Exo_model_S3$simulation$ck_im_6 - Exo_model$simulation$ck_im_6)/Exo_model$simulation$ck_im_6*100, col = "yellow", lwd=3, xlab="");
lines((Exo_model_S3$simulation$ck_im_7 - Exo_model$simulation$ck_im_7)/Exo_model$simulation$ck_im_7*100, col = "pink", lwd=3, xlab="");
lines((Exo_model_S3$simulation$ck_im_8 - Exo_model$simulation$ck_im_8)/Exo_model$simulation$ck_im_8*100, col = "darkgreen", lwd=3, xlab="");
lines((Exo_model_S3$simulation$ck_im_9 - Exo_model$simulation$ck_im_9)/Exo_model$simulation$ck_im_9*100, col = "darkblue", lwd=3, xlab="");
legend("bottomleft",legend=c("Industry 1 (Agriculture)", "Industry 2 (Forresty)","Industry 3 (Fishery)","Industry 4 (Mining)","Industry 5 (Manu. food)","Industry 6 (Energy prod.)","Industry 7 (Energy inten.)","Industry 8 (Financial corp.)","Industry 9 (other industries)"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue","green", "black","orange", "yellow", "pink", "darkgreen", "darkblue")); grid()
```
...
plot(Exo_model_S3$simulation$xk, col= "red", ylab= "B. DKR" , main= "Real Export" , xlim= c(c(1998,2020)), lwd=3, xlab="", cex.main=1); lines(Exo_model$simulation$xk, col = "blue", lwd=3, xlab=""); 
legend("topleft",legend=c("Increase in interest rates", "Baseline"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue"), cex=1); grid()

plot(Exo_model_S3$simulation$imk, col= "red", ylab= "1000 people" , main= "Real Import" , lwd=3, xlab="", cex.main=1); 
lines(Exo_model$simulation$imk, col = "blue", lwd=3, xlab=""); 
legend("topleft",legend=c("Increase in interest rates", "Baseline"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue"), cex=1); 
grid()
```
...
plot(Exo_model_S3$simulation$yk, col= "red", ylab= "B. DKR" , main= "Real GDP", ylim=c(1300,2300) , xlim= c(c(1998,2020)), lwd=3, xlab="", cex.main=1); lines(Exo_model$simulation$yk, col = "blue", lwd=3, xlab=""); 
legend("topleft",legend=c("Increase in interest rates", "Baseline"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue"), cex=1); grid()

plot(Exo_model_S3$simulation$emp_tot, col= "red", ylab= "1000 people" , main= "employment" , lwd=3, xlab="", cex.main=1); 
lines(Exo_model$simulation$emp_tot, col = "blue", lwd=3, xlab=""); 
legend("topleft",legend=c("Increase in interest rates", "Baseline"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue"), cex=1); 
grid()
...
plot((Exo_model_S2$simulation$ppcon_oth_tot - Exo_model$simulation$ppcon_oth_tot)*100, ylim=c(-4,4),col= "red", ylab= "Change in percentage points" , main= "Consumer prices Scenario 2", lwd=3, xlab="", cex.main=1.5);
lines((Exo_model_S2$simulation$ppcon_110_tot - Exo_model$simulation$ppcon_110_tot)*100, col = "blue", lwd=3, xlab=""); 
lines((Exo_model_S2$simulation$ppcon_120_tot - Exo_model$simulation$ppcon_120_tot)*100, col = "green", lwd=3, xlab="");
lines((Exo_model_S2$simulation$ppcon_130_tot - Exo_model$simulation$ppcon_130_tot)*100, col = "black", lwd=3, xlab="");
lines((Exo_model_S2$simulation$ppcon_140_tot - Exo_model$simulation$ppcon_140_tot)*100, col = "orange", lwd=3, xlab="");
...
plot((Exo_model_S2$simulation$ck_oth_tot - Exo_model$simulation$ck_oth_tot)/Exo_model$simulation$ck_oth_tot*100, ylim=c(-4,4),col= "red", ylab= "Percentage change" , main= "Real consumptions Scenario 2", lwd=3, xlab="", cex.main=1.5);
lines((Exo_model_S2$simulation$ck_110_tot - Exo_model$simulation$ck_110_tot)/Exo_model$simulation$ck_110_tot*100, col = "blue", lwd=3, xlab=""); 
lines((Exo_model_S2$simulation$ck_120_tot - Exo_model$simulation$ck_120_tot)/Exo_model$simulation$ck_120_tot*100, col = "green", lwd=3, xlab="");
lines((Exo_model_S2$simulation$ck_130_tot - Exo_model$simulation$ck_130_tot)/Exo_model$simulation$ck_130_tot*100, col = "black", lwd=3, xlab="");
lines((Exo_model_S2$simulation$ck_140_tot - Exo_model$simulation$ck_140_tot)/Exo_model$simulation$ck_140_tot*100, col = "orange", lwd=3, xlab="");
...
plot((Exo_model_S2$simulation$exk_dom_1 - Exo_model$simulation$exk_dom_1)/Exo_model$simulation$exk_dom_1*100, ylim=c(-70,2),col= "red", ylab= "Percentage change" , main= "Change in Real Exports: Scenario 2", lwd=3, xlab="", cex.main=1.5);
lines((Exo_model_S2$simulation$exk_dom_2 - Exo_model$simulation$exk_dom_2)/Exo_model$simulation$exk_dom_2*100, col = "blue", lwd=3, xlab=""); 
lines((Exo_model_S2$simulation$exk_dom_3 - Exo_model$simulation$exk_dom_3)/Exo_model$simulation$exk_dom_3*100, col = "green", lwd=3, xlab="");
lines((Exo_model_S2$simulation$exk_dom_4 - Exo_model$simulation$exk_dom_4)/Exo_model$simulation$exk_dom_4*100, col = "black", lwd=3, xlab="");
lines((Exo_model_S2$simulation$exk_dom_5 - Exo_model$simulation$exk_dom_5)/Exo_model$simulation$exk_dom_5*100, col = "orange", lwd=3, xlab="");
...
plot((Exo_model_S2$simulation$phi_c_oth - Exo_model$simulation$phi_c_oth)*100, col= "red", ylab= "Level change from baseline" , main= "Import shares of final consumption: Scenario 2", lwd=3, ylim= c(-0,5), cex.main=1.5);
lines((Exo_model_S2$simulation$phi_c_110 - Exo_model$simulation$phi_c_110)*100, col = "blue", lwd=3, xlab=""); 
lines((Exo_model_S2$simulation$phi_c_120 - Exo_model$simulation$phi_c_120)*100, col = "green", lwd=3, xlab="");
lines((Exo_model_S2$simulation$phi_c_130 - Exo_model$simulation$phi_c_130)*100, col = "black", lwd=3, xlab="");
lines((Exo_model_S2$simulation$phi_c_140 - Exo_model$simulation$phi_c_140)*100, col = "orange", lwd=3, xlab="");
...
plot(zk_im_1_tot_S2/zk_1_tot_S2*100 - zk_im_1_tot_BS/zk_1_tot_BS*100, col= "red", ylab= "Percentage change from baseline" , main= "Import shares on inputs: Scenario 2", lwd=3, ylim= c(-0.2,5), cex.main=1.5);
lines(zk_im_2_tot_S2/zk_2_tot_S2*100 - zk_im_2_tot_BS/zk_2_tot_BS*100, col = "blue", lwd=3, xlab=""); 
lines(zk_im_3_tot_S2/zk_3_tot_S2*100 - zk_im_3_tot_BS/zk_3_tot_BS*100, col = "green", lwd=3, xlab="");
lines(zk_im_4_tot_S2/zk_4_tot_S2*100 - zk_im_4_tot_BS/zk_4_tot_BS*100, col = "black", lwd=3, xlab="");
lines(zk_im_5_tot_S2/zk_5_tot_S2*100 - zk_im_5_tot_BS/zk_5_tot_BS*100, col = "orange", lwd=3, xlab="");
...
plot((Exo_model_S2$simulation$nxk - Exo_model$simulation$nxk), col= "red", ylab= "Change from baseline (B. DKR)" , main= "Real net-export: Scenario 2" , xlim= c(1998,2020), lwd=3, xlab="", cex.main=1.5);grid()
...
plot((Exo_model_S1$simulation$exk_dom_1 - Exo_model$simulation$exk_dom_1)/Exo_model$simulation$exk_dom_1*100, ylim=c(-70,2),col= "red", ylab= "Percentage change" , main= "Change in Real Exports: Scenario 1", lwd=3, xlab="", cex.main=1.5);
...
plot((Exo_model_S1$simulation$phi_c_oth - Exo_model$simulation$phi_c_oth)*100, col= "red", ylab= "Level change from baseline" , main= "Import shares of final consumption: Scenario 1", lwd=3, ylim= c(-0,5), cex.main=1.5);
...
plot(zk_im_1_tot_S1/zk_1_tot_S1*100 - zk_im_1_tot_BS/zk_1_tot_BS*100, col= "red", ylab= "Percentage change from baseline" , main= "Import shares on inputs: Scenario 1", lwd=3, ylim= c(-0.2,5), cex.main=1.5);
...
plot((Exo_model_S1$simulation$fnw_hk - Exo_model$simulation$fnw_hk), col= "red", ylab= "Change from baseline (B. DKR)" , main= "Financial net wealth HH" , xlim= c(c(1998,2020)),ylim= c(-30,10), lwd=3, xlab="", cex.main=1.5);lines((Exo_model_S2$simulation$fnw_hk - Exo_model$simulation$fnw_hk), col = "blue", lwd=3, xlab="");grid()

plot((Exo_model_S1$simulation$fnw_gk - Exo_model$simulation$fnw_gk), col= "red", ylab= "Change from baseline (B. DKR)" , main= "Financial net wealth Government" , xlim= c(1998,2020), ylim= c(-25,25), lwd=3, xlab="", cex.main=1.5);lines((Exo_model_S2$simulation$fnw_gk - Exo_model$simulation$fnw_gk), col = "blue", lwd=3, xlab="");grid()


plot((Exo_model_S1$simulation$fnw_nfck - Exo_model$simulation$fnw_nfck), col= "red", ylab= "Change from baseline (B. DKR)" , main= "Financial net wealth Non-financial corporations" , xlim= c(1998,2020), ylim= c(-25,14), lwd=3, xlab="", cex.main=1.5);lines((Exo_model_S2$simulation$fnw_nfck - Exo_model$simulation$fnw_nfck), col = "blue", lwd=3, xlab="");grid()



plot((Exo_model_S1$simulation$fnw_rowk - Exo_model$simulation$fnw_rowk), col= "red", ylab= "Change from baseline (B. DKR)" , main= "Financial net wealth ROW" , xlim= c(1998,2020), ylim= c(-20,50), lwd=3, xlab="", cex.main=1.5);lines((Exo_model_S2$simulation$fnw_rowk - Exo_model$simulation$fnw_rowk), col = "blue", lwd=3, xlab="");grid()
...
plot((Exo_model_S1$simulation$b2_1/Exo_model_S1$simulation$pout_1 - Exo_model$simulation$b2_1/Exo_model$simulation$pout_1)/Exo_model$simulation$b2_1/Exo_model$simulation$pout_1*100, col= "red", ylab= "% change from baseline" , main= "Profits and mixed income", lwd=3, ylim= c(-28,2));
lines((Exo_model_S1$simulation$b2_2/Exo_model_S1$simulation$pout_2 - Exo_model$simulation$b2_2/Exo_model$simulation$pout_2)/Exo_model$simulation$b2_2/Exo_model$simulation$pout_2*100, col = "blue", lwd=3, xlab=""); 
lines((Exo_model_S1$simulation$b2_3/Exo_model_S1$simulation$pout_3 - Exo_model$simulation$b2_3/Exo_model$simulation$pout_3)/Exo_model$simulation$b2_3/Exo_model$simulation$pout_3*100, col = "green", lwd=3, xlab="");
lines((Exo_model_S1$simulation$b2_4/Exo_model_S1$simulation$pout_4 - Exo_model$simulation$b2_4/Exo_model$simulation$pout_4)/Exo_model$simulation$b2_4/Exo_model$simulation$pout_4*100, col = "black", lwd=3, xlab="");
lines((Exo_model_S1$simulation$b2_5/Exo_model_S1$simulation$pout_5 - Exo_model$simulation$b2_5/Exo_model$simulation$pout_5)/Exo_model$simulation$b2_5/Exo_model$simulation$pout_5*100, col = "orange", lwd=3, xlab="");
lines((Exo_model_S1$simulation$b2_6/Exo_model_S1$simulation$pout_6 - Exo_model$simulation$b2_6/Exo_model$simulation$pout_6)/Exo_model$simulation$b2_6/Exo_model$simulation$pout_6*100, col = "yellow", lwd=3, xlab="");
lines((Exo_model_S1$simulation$b2_7/Exo_model_S1$simulation$pout_7 - Exo_model$simulation$b2_7/Exo_model$simulation$pout_7)/Exo_model$simulation$b2_7/Exo_model$simulation$pout_7*100, col = "pink", lwd=3, xlab="");
lines((Exo_model_S1$simulation$b2_8/Exo_model_S1$simulation$pout_8 - Exo_model$simulation$b2_8/Exo_model$simulation$pout_8)/Exo_model$simulation$b2_8/Exo_model$simulation$pout_8*100, col = "darkgreen", lwd=3, xlab="");
lines((Exo_model_S1$simulation$b2_9/Exo_model_S1$simulation$pout_9 - Exo_model$simulation$b2_9/Exo_model$simulation$pout_9)/Exo_model$simulation$b2_9/Exo_model$simulation$pout_9*100, col = "darkblue", lwd=3, xlab="");
legend("bottomleft",legend=c("Industry 1 (Agriculture)", "Industry 2 (Forresty)","Industry 3 (Fishery)","Industry 4 (Mining)","Industry 5 (Manu. food)","Industry 6 (Energy prod.)","Industry 7 (Energy inten.)","Industry 8 (Financial corp.)","Industry 9 (other industries)"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue","green", "black","orange", "yellow", "pink", "darkgreen", "darkblue")); grid()
...
plot((Exo_model_S1$simulation$Co2E_1 - Exo_model$simulation$Co2E_1)/Exo_model$simulation$Co2E_1*100, col= "red", ylab= "Percentage change from baseline" , main= "Total Co2-Equivelant emission: Scenario 1", lwd=3, ylim= c(-0.5,0));
...
plot((Exo_model_S2$simulation$Co2E_1 - Exo_model$simulation$Co2E_1)/Exo_model$simulation$Co2E_1*100, col= "red", ylab= "Percentage change from baseline" , main= "Total Co2-Equivelant emission: Scenario 2", lwd=3, ylim= c(-20,1));
lines((Exo_model_S2$simulation$Co2E_2 - Exo_model$simulation$Co2E_2)/Exo_model$simulation$Co2E_2*100, col = "blue", lwd=3, xlab=""); 
lines((Exo_model_S2$simulation$Co2E_3 - Exo_model$simulation$Co2E_3)/Exo_model$simulation$Co2E_3*100, col = "green", lwd=3, xlab="");
lines((Exo_model_S2$simulation$Co2E_4 - Exo_model$simulation$Co2E_4)/Exo_model$simulation$Co2E_4*100, col = "black", lwd=3, xlab="");
lines((Exo_model_S2$simulation$Co2E_5 - Exo_model$simulation$Co2E_5)/Exo_model$simulation$Co2E_5*100, col = "orange", lwd=3, xlab="");
...
plot((Exo_model_S1$simulation$Co2E_tot - Exo_model$simulation$Co2E_tot)/Exo_model$simulation$Co2E_tot*100, col= "red", ylab= "Percentage change in Co2 equivelant" , main= "Total Co2-Equivelant emission: Scenario 1", lwd=3); 
legend("bottomleft",legend=c("implementation of consumer tax", "Baseline"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue"), cex=1); grid()


plot((Exo_model_S2$simulation$Co2E_tot - Exo_model$simulation$Co2E_tot)/Exo_model$simulation$Co2E_tot*100, col= "red", ylab= "Percentage change in Co2 equivelant" , main= "Total Co2-Equivelant emission: Scenario 2", lwd=3); 
legend("bottomleft",legend=c("implementation of consumer tax", "Baseline"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue"), cex=1); grid()
